...
public class Circle
{
    ...
    /**
     * Returns true if the aRect is a bounding rectangle; false otherwise
     * @param aRect an instance of a Rectangle
     * @return true if the aRect is a bounding rectangle; false otherwise
     */
    public Boolean isBoundingBox(Rectangle aRect){
        return false;
    }
